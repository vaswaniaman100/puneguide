...
public class religiousplacestypelist extends AppCompatActivity {
    Context context = this;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.religiousplacestypelist);
        ...
        String a = "SELECT DISTINCT type from religiousplaces";
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                params.height = 200;
                LinearLayout layout = (LinearLayout) findViewById(R.id.religiousplacestypelistlayout);
                name.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {

                        Intent intent = new Intent(context, religiousplacesnamelist.class);
                        intent.putExtra("type", name.getText().toString());
                        cursor.close();
                        db.close();
