...
public class shoppingmarketlist extends AppCompatActivity {
    Context context = this;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.shoppingmarketlist);
        ...
        String a = "select name from shoppingmarketarea";
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                params.height = 200;
                LinearLayout layout = (LinearLayout) findViewById(R.id.shoppingmarketarealayout);
               name.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {

                        Intent intent = new Intent(context, shoppinmarketdata.class);
