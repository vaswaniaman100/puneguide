...
public class trainlist extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       String source = null;
        ...
        if (bundle != null)
        {
             source = bundle.getString("sourcestation");
            destination = bundle.getString("deststation");
        }
                ...
                box.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final Cursor cursor1 = db.rawQuery("select x.stname from tabledelete x, train y\n" +
                                "where x.stationcode = y.stationcode and x.trainno="+trainno.getText()+" And y.trainno="+trainno.getText()+" And y.stname='"+ finalSource +"'", new String[]{});
                        final Cursor cursor2 = db.rawQuery("select x.stname from tabledelete x, train y\n" +
                                "where x.stationcode = y.stationcode and x.trainno="+trainno.getText()+" And y.trainno="+trainno.getText()+" And y.stname='"+ finalDestination +"'", new String[]{});

                        while (cursor1.moveToNext()) {
                            h=cursor1.getString(0);
                        }
                        ...
                        intent.putExtra("source",h);
                        intent.putExtra("destination", i);
                        intent.putExtra("sourcestation", finalSource);
                        intent.putExtra("deststation", finalDestination);
