...
public class theaterslist extends AppCompatActivity {
    Context context = this;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.theaterslist);
        ...
        String a = "select name from theaters";
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                params.height = 200;
                LinearLayout layout = (LinearLayout) findViewById(R.id.theaterslistlayout);
                name.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {

                        Intent intent = new Intent(context, theatersdata.class);
