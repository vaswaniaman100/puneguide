...
public class touristplaceslist extends AppCompatActivity {
    Context context = this;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.touristplaceslist);
        ...
        String a = "select name from touristplaces";
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                params.height = 200;
                LinearLayout layout = (LinearLayout) findViewById(R.id.touristplaceslayout);
                name.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {

                        Intent intent = new Intent(context, touristplacedata.class);
